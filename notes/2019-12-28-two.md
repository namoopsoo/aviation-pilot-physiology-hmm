### Summary
Trying multiple epochs here finally. The [final validation logloss](https://github.com/namoopsoo/aviation-pilot-physiology-hmm/edit/master/notes/2019-12-28-two-plot.md)  plot however shows that the multi-epoch approach doesn't help, because the loglos sstill fundamentally just on average is reduced for some classes but at the cost of higher loss for other classes.
